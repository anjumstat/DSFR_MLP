# Dynamic Sparse Focus Regularization (DSFR) - MLP
...
Species: Original species name (e.g., Triticum aestivum, Oryza sativa, Hordeum vulgare, and Brachypodium distachyon).
